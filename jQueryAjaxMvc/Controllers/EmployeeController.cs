    ...
    public class EmployeeController : Controller
    {
        ...
        public ActionResult AddOrEdit(Employee emp)
        {
            try
            {
                ...
                return Json(new { success = true, html = Global.RenderRazorViewToString(this, "ViewAll", GetAllEmployee()), message = "Submitted Successfully" }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                ...
                return Json(new { success = true, html = Global.RenderRazorViewToString(this, "ViewAll", GetAllEmployee()), message = "Deleted Successfully" }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
                return Json(new { success = false, message = ex.Message.ToString() }, JsonRequestBehavior.AllowGet);
